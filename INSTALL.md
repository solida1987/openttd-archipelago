...
The pre-launcher build with its own in-game server login rides along on every
release as **`openttd-archipelago-legacy-*-win64.zip`**. It is discontinued and
will not be updated; see the README's Legacy section for what that means.
