...
- **7 traps** — Breakdown Wave (60s duration), Recession, Maintenance Surge, Signal Failure, Fuel Shortage, Forced Bank Loan, Industry Closure, Vehicle License Revoke (1-2 year temp ban)
- **8 utility items** — Cash Injections (£50k/£200k/£500k), Loan Reduction, Cargo Bonus 2×, Reliability Boost, Station Upgrade, Town Growth
- **20 Speed Boost items** — each grants +10% fast-forward speed (up to 300%)
...
- **Colby Event** — multi-step storyline with arrest/escape/sacrifice decision popups (reopenable if dismissed)
- **Mission-linked industry protection** — industries tied to active missions cannot close down
- **Dynamic pool scaling** — mission and shop counts scale automatically with player count (1–24 players)
- **Balanced item distribution** — progression items split 40% missions / 40% shop / 10% ruins / 10% demigods
...
1. Download `openttd-archipelago-exp-1.2.3-win64.zip` from [Releases](../../releases/latest)
