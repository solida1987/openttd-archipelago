...
remains downloadable for anyone who prefers not to use the launcher: look for
the release marked **`legacy`** and download the win64 zip from it. It plays
Archipelago the old way, on the multiworld versions of its era.
