...
class WrathLimitTrees(Range):
    """How many trees you can clear per year before the God of Wackens notices."""
    display_name = "Wrath: Tree Limit (trees per year)"
    range_start = 1
    range_end = 1000
    default = 10
...
class OpenTTDOptions(PerGameCommonOptions):
    ...
    wrath_limit_trees:               WrathLimitTrees
    # Multiplayer
