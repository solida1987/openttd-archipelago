...
static CallBackFunction ToolbarArchipelagoClick([[maybe_unused]] Window *w)
{
...
static std::unique_ptr<NWidgetBase> MakeMainToolbar()
{
	...
	static const std::tuple<WidgetID, WidgetType, SpriteID> toolbar_button_sprites[] = {
		...
		{WID_TN_ARCHIPELAGO,  WWT_IMGBTN,     (SpriteID)712}, /* AP: slot 712 (SPR_IMG_PLAY_MUSIC) replaced by archipelago_icons.grf; falls back to ▶ if GRF absent */
